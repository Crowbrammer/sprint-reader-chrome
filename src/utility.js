...
function getMoreAdvancedSettings() {
  madvStaticFocalUnicodeCharacter = getFromLocalNotEmpty(
    "madvStaticFocalUnicodeCharacter",
    madvStaticFocalUnicodeCharacter
  );
  madvEnableSpaceInsertion = getFromLocalNotEmpty(
    "madvEnableSpaceInsertion",
    madvEnableSpaceInsertion
  );
  madvRemoveLastSlideNullOrEmpty = getFromLocalNotEmpty(
    "madvRemoveLastSlideNullOrEmpty",
    madvRemoveLastSlideNullOrEmpty
  );
  madvEnableHyphenatedWordSplit = getFromLocalNotEmpty(
    "madvEnableHyphenatedWordSplit",
    madvEnableHyphenatedWordSplit
  );
  madvConsolidateHyphenatedWord = getFromLocalNotEmpty(
    "madvConsolidateHyphenatedWord",
    madvConsolidateHyphenatedWord
  );

  madvEnableLongWordHyphenation = getFromLocalNotEmpty(
    "madvEnableLongWordHyphenation",
    madvEnableLongWordHyphenation
  );
  madvLongWordTriggerCharacterCount = getFromLocalGreaterThanZero(
    "madvLongWordTriggerCharacterCount",
    madvLongWordTriggerCharacterCount
  );
  madvLongWordMinCharacterPerSlidePostSplit = getFromLocalGreaterThanZero(
    "madvLongWordMinCharacterPerSlidePostSplit",
    madvLongWordMinCharacterPerSlidePostSplit
  );
  madvLongWordCharacterTriggerDoNotJoin = getFromLocalGreaterThanZero(
    "madvLongWordCharacterTriggerDoNotJoin",
    madvLongWordCharacterTriggerDoNotJoin
  );

  madvEnableAcronymDetection = getFromLocalNotEmpty(
    "madvEnableAcronymDetection",
    madvEnableAcronymDetection
  );
  madvEnableNumberDecimalDetection = getFromLocalNotEmpty(
    "madvEnableNumberDecimalDetection",
    madvEnableNumberDecimalDetection
  );
  madvDeleteEmptySlides = getFromLocalNotEmpty(
    "madvDeleteEmptySlides",
    madvDeleteEmptySlides
  );
  madvWPMAdjustmentStep = getFromLocalGreaterThanZero(
    "madvWPMAdjustmentStep",
    madvWPMAdjustmentStep
  );

  madvWordFreqMinimumSlideDuration = getFromLocalGreaterThanZero(
    "madvWordFreqMinimumSlideDuration",
    madvWordFreqMinimumSlideDuration
  );
  madvWordFreqHighestFreqSlideDuration = getFromLocalGreaterThanZero(
    "madvWordFreqHighestFreqSlideDuration",
    madvWordFreqHighestFreqSlideDuration
  );
  madvWordFreqLowestFreqSlideDuration = getFromLocalGreaterThanZero(
    "madvWordFreqLowestFreqSlideDuration",
    madvWordFreqLowestFreqSlideDuration
  );

  madvWordLengthMinimumSlideDuration = getFromLocalGreaterThanZero(
    "madvWordLengthMinimumSlideDuration",
    madvWordLengthMinimumSlideDuration
  );
  madvBasicMinimumSlideDuration = getFromLocalGreaterThanZero(
    "madvBasicMinimumSlideDuration",
    madvBasicMinimumSlideDuration
  );

  madvAlwaysHideFocalGuide = getFromLocalNotEmpty(
    "madvAlwaysHideFocalGuide",
    madvAlwaysHideFocalGuide
  );
  madvOptimisedPositionLeftMarginPercent = getFromLocalGreaterThanZero(
    "madvOptimisedPositionLeftMarginPercent",
    madvOptimisedPositionLeftMarginPercent
  );
  madvDisplaySentenceWhenPaused = getFromLocalNotEmpty(
    "madvDisplaySentenceWhenPaused",
    madvDisplaySentenceWhenPaused
  );
  madvAutoHideSentence = getFromLocalNotEmpty(
    "madvAutoHideSentence",
    madvAutoHideSentence
  );
  madvAutoHideSentenceSeconds = getFromLocalGreaterThanZero(
    "madvAutoHideSentenceSeconds",
    madvAutoHideSentenceSeconds
  );
  madvDisplaySentenceTopBorder = getFromLocalNotEmpty(
    "madvDisplaySentenceTopBorder",
    madvDisplaySentenceTopBorder
  );
  madvDisplaySentenceAtReaderOpen = getFromLocalNotEmpty(
    "madvDisplaySentenceAtReaderOpen",
    madvDisplaySentenceAtReaderOpen
  );
  madvSentenceBackwardWordCount = getFromLocalGreaterThanZero(
    "madvSentenceBackwardWordCount",
    madvSentenceBackwardWordCount
  );
  madvSentencePositionPercentOffset = getFromLocalGreaterThanZero(
    "madvSentencePositionPercentOffset",
    madvSentencePositionPercentOffset
  );
  madvLargeStepNumberOfSlides = getFromLocalGreaterThanZero(
    "madvLargeStepNumberOfSlides",
    madvLargeStepNumberOfSlides
  );
  madvDisplayProgress = getFromLocalNotEmpty(
    "madvDisplayProgress",
    madvDisplayProgress
  );
  madvDisplaySocial = getFromLocalNotEmpty(
    "madvDisplaySocial",
    madvDisplaySocial
  );
  madvDisplayWPMSummary = getFromLocalNotEmpty(
    "madvDisplayWPMSummary",
    madvDisplayWPMSummary
  );

  madvHotkeySelectionEnabled = getFromLocalNotEmpty(
    "madvHotkeySelectionEnabled",
    madvHotkeySelectionEnabled
  );

  madvSaveSlidePosition = getFromLocalNotEmpty(
    "madvSaveSlidePosition",
    madvSaveSlidePosition
  );
}
...
function getFromLocalIsNumber(key, variable) {
  if (
    !isEmpty(localStorage.getItem(key)) &&
...
function getLanguage(selectedText) {
  ...
  var patternJS =
    "../lib/guess_language/language_patterns/" + language.pattern + ".js";
  $.ajax({
    async: false,
    url: patternJS,
    dataType: "script"
...
function saveSelectedTextToResource(latestTextSelection) {
  ...
  var text = getSelectedTextFromResourceString(
    localStorage.getItem("selectedText")
  );
  if (text.text == latestTextSelection) return;

  var hist1 = getSelectedTextFromResourceString(
    localStorage.getItem("selectedTextHistory1")
  );
...
module.exports.htmlEntitiesDecode = htmlEntitiesDecode;
